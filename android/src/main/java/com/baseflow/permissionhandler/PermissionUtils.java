...
public class PermissionUtils {
    ...
    static int toPermissionStatus(final Activity activity, final String permissionName, int grantResult) {
        Log.d("quang", "per: "+permissionName+" "+Build.VERSION.SDK_INT);
        if (Build.VERSION.SDK_INT >= 33)
        {


                if(permissionName.equals(Manifest.permission.READ_EXTERNAL_STORAGE) || permissionName.equals(Manifest.permission.WRITE_EXTERNAL_STORAGE))
                {
                    Log.d("quang", "per1: "+permissionName+" "+ContextCompat.checkSelfPermission(activity, Manifest.permission.READ_EXTERNAL_STORAGE)+ ", "+ContextCompat.checkSelfPermission(activity, Manifest.permission.WRITE_EXTERNAL_STORAGE) );
                    Log.d("quang", "per1: "+permissionName+" "+ContextCompat.checkSelfPermission(activity, Manifest.permission.READ_MEDIA_IMAGES)+ ", "+ContextCompat.checkSelfPermission(activity, Manifest.permission.READ_MEDIA_VIDEO) );
                    ...
                    if ( ContextCompat.checkSelfPermission(activity, Manifest.permission.READ_EXTERNAL_STORAGE)
                            ...
                            == PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(activity, Manifest.permission.READ_MEDIA_IMAGES)
                            == PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(activity, Manifest.permission.READ_MEDIA_VIDEO)
                            == PackageManager.PERMISSION_GRANTED) {
                        Log.d("quang", "per2: "+permissionName+" "+Build.VERSION.SDK_INT);
